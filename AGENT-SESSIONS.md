...
1. The initial OTP implementation handled the verification secret incorrectly. It was corrected to use Appwrite's session creation with the entered OTP code.
